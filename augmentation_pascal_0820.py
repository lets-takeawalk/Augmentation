...
am.createFolder(AUG_AFT_IMG_FOLDER)
...
while cnt<aug_count:
    for file_name, path in file_dic.items():
        ...
        am.save_aug_xml(checked_box,save_name+'.jpg',path['xml_path'],save_path)
        cnt+=1
